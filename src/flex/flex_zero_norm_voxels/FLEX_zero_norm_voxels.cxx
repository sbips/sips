...
int main( int argc, char* argv[] )
{
  ...
  // Read input image  (read after mask so output type is determined by input not mask type)
  ...
  // Masking
	...
	for ( mask_it.GoToBegin(), input_it.GoToBegin();
			!input_it.IsAtEnd(); ++input_it, ++mask_it )
		if ( mask_it.Get() > atof( argv[3] ) || mask_it.Get() < 0 )
		  input_it.Set( 0 );
