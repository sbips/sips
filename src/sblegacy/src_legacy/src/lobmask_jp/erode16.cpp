...
//////////////////////// GLOBAL VARIABLES //////////////////////////////////
typedef unsigned char segtype; // EG - quick modification to work with 16 bit T1 images
typedef unsigned short t1type; // EG

segtype *seg_img;
int sz[3], area, volume;
unsigned char FINAL_VALUE = 253;
////////////////////////////// FUNCTIONS ///////////////////////////////////
void find_borders(const segtype *img, int *B);
void peel_one_layer_and_remove_csf(segtype *s, int *B);
int find_seed(int *B);
...
Example: erode xxx_sinc_acpc_T1_masked xxx_sinc_acpc_T1_fseg xxx_acpc_erode
 ...
 "<< endl;
    ...
    info hdr_info;
    seg_img = read_analyze<segtype>(argv[2], hdr_info);
    ...
    volume = area * sz[2];
    info hdr_info1;
    t1type *T1_img = read_analyze<t1type>(argv[1], hdr_info1);
    ...
    write_analyze(argv[3] , T1_img, hdr_info1);
...
////////////////////////////////////////////////////////////////////////////
bool acceptable(const segtype *pos){
