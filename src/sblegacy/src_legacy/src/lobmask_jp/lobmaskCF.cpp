...
// To get Thalamus.
// compile with:
// /home/brainlab/gcc-2.95.3/bin/g++ -O2 -o lobmaskCF lobmaskCF.cpp
...
int main(int argc, char ** argv)
{
    if(argc != 6 )
      {
	cout <<"Usage: lobmaskCF <BasalGangliaThalamus_File(BGT)> <Singulate_Mask_File> <OutputFile> -g GridFile"<<endl;
